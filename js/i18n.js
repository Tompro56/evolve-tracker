...
const DICT = {
  fr: {
    ...
    metric_km: 'km',
    col_current_week: 'Semaine en cours',
    col_total: 'Total',
    ...
    show_in_feed: 'Afficher dans le fil',
    rides: 'Rides',
    charges: 'Charges',
    tab_charge: 'Charge',
    ...
    new_maintenance: '+ Nouvel entretien',
    estimated_range: 'Autonomie estimée',
    autonomy_all: 'Tout',
    autonomy_mini: 'Mini',
    autonomy_moyenne: 'Moyenne',
    autonomy_maxi: 'Maxi',
    min_budget: 'Budget min (€)',
    max_budget: 'Budget max (€)',
    intervention_type: "Type d'intervention",
    avg_injection: 'Injection moyenne',
    whats_new: 'détails',
    whats_new_title: 'Nouveautés',
    avg_km_between_charges: 'Km moy. entre charges',
    avg_days_between_charges: 'Jours moy. entre charges',
    budget: 'Budget',
    ...
    extend_ride: 'Prolonger le dernier ride',
    ...
    wheel_types: 'Usages de roue',
    add_wheel_type: '+ Ajouter un usage de roue',
  ...
  en: {
    ...
    autonomy_all: 'All',
    autonomy_mini: 'Min',
    autonomy_moyenne: 'Average',
    autonomy_maxi: 'Max',
    min_budget: 'Min budget (€)',
    max_budget: 'Max budget (€)',
    intervention_type: 'Intervention type',
    avg_injection: 'Avg. injection',
    whats_new: 'details',
    whats_new_title: "What's new",
    avg_km_between_charges: 'Avg. km between charges',
    avg_days_between_charges: 'Avg. days between charges',
    budget: 'Budget',
    ...
    wheel_types: 'Wheel usages',
    add_wheel_type: '+ Add a wheel usage',
