...
const DICT = {
  fr: {
    ...
    km_week: 'Km cette semaine',
    km_total: 'Km au total',
    consumption_week: 'Conso. moy. semaine',
    consumption_total: 'Conso. moy. totale',
  ...
  en: {
    ...
    avg_range: 'Avg. range',
    km_week: 'Km this week',
    km_total: 'Total km',
    consumption_week: 'Avg. consumption (week)',
    consumption_total: 'Avg. consumption (total)',
    last_trip: 'Last trip',
